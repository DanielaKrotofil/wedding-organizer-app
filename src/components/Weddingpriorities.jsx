...
const WeddingPrio = () => {
    ...
    return (
        ...
        <div className="wedding-priorities__text">
            <p>At the very beginning of preparations for the wedding, it is worth determining what your priorities are, i.e. what is most important to you and you cannot imagine saving on it.
