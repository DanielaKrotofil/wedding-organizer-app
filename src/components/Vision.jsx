...
<div className="wedding-styles__inspirations-buttons">
                <a href= className="btn">Greenry</a>
...
const titles = ['Characteristic', 'Primary colors', 'Another colors', 'Decorations'];
        {titles.map((titles, inddex) => {
            return <p key={inddex}>{titles}</p>
        })}
*/
